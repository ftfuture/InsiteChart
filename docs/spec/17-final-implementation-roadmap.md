...
### 4.3 Phase 2: 핵심 API 및 서비스 구현 (4주)
...
### 4.4 Phase 3: 기본 프론트엔드 및 UI 구현 (4주)
...
gantt
    ...
    주식 데이터 수집          :p1-1, after p0-2, 2w
    소셜 데이터 수집          :p1-2, after p1-1, 2w
    
    section Phase 2: API 구현
    주식 검색 API             :p2-1, after p1-2, 2w
    센티먼트 분석 API         :p2-2, after p2-1, 2w
    
    section Phase 3: 프론트엔드
    기본 UI 구현              :p3-1, after p2-2, 2w
    대시보드 구현             :p3-2, after p3-1, 2w
    
    section Phase 4: 고급 기능
    상관관계 분석             :p4-1, after p3-2, 2w
    실시간 스트리밍           :p4-2, after p4-1, 2w
    
    section Phase 5: 통합
    시스템 통합               :p5-1, after p4-2, 2w
    최적화 및 테스트          :p5-2, after p5-1, 1w
    
    section Phase 6: 배포
    프로덕션 배포             :p6-1, after p5-2, 1w
